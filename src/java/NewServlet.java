...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mobno=request.getParameter("pno");
        String address=request.getParameter("paddr");
        String medical_hist=request.getParameter("mh");
...
sql="insert into patient_details values('"+name+"','"+mail+"',"+age+",'"+mobno+"','"+address+"','"+medical_hist+"','"+u_id+"');";
sql1="insert into hello values('"+304+"');";		
st=connection.createStatement();
		st.executeUpdate(sql);
            ...
            out.println("<h1> Your details have been sucessfully added into our medical files</h1>");
            out.println("</body>");
            out.println("</html>");
    }
    catch(Exception e)
